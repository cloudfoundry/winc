...
func (fake *FakeMounter) Mount(pid int, volumePath string) error {
...
func (fake *FakeMounter) MountArgsForCall(i int) (int, string) {
	fake.mountMutex.RLock()
	defer fake.mountMutex.RUnlock()
...
func (fake *FakeMounter) Unmount(pid int) error {
...
func (fake *FakeMounter) UnmountArgsForCall(i int) int {
	fake.unmountMutex.RLock()
	defer fake.unmountMutex.RUnlock()
...
var _ container.Mounter = new(FakeMounter)
