...
func (fake *FakePortAllocator) AllocatePort(handle string, port int) (int, error) {
...
func (fake *FakePortAllocator) AllocatePortCallCount() int {
	fake.allocatePortMutex.RLock()
	defer fake.allocatePortMutex.RUnlock()
	return len(fake.allocatePortArgsForCall)
}

func (fake *FakePortAllocator) AllocatePortArgsForCall(i int) (string, int) {
	fake.allocatePortMutex.RLock()
	defer fake.allocatePortMutex.RUnlock()
	return fake.allocatePortArgsForCall[i].handle, fake.allocatePortArgsForCall[i].port
}

func (fake *FakePortAllocator) AllocatePortReturns(result1 int, result2 error) {
...
func (fake *FakePortAllocator) AllocatePortReturnsOnCall(i int, result1 int, result2 error) {
	fake.AllocatePortStub = nil
...
func (fake *FakePortAllocator) ReleaseAllPorts(handle string) error {
...
func (fake *FakePortAllocator) ReleaseAllPortsCallCount() int {
	fake.releaseAllPortsMutex.RLock()
	defer fake.releaseAllPortsMutex.RUnlock()
	return len(fake.releaseAllPortsArgsForCall)
}

func (fake *FakePortAllocator) ReleaseAllPortsArgsForCall(i int) string {
	fake.releaseAllPortsMutex.RLock()
	defer fake.releaseAllPortsMutex.RUnlock()
	return fake.releaseAllPortsArgsForCall[i].handle
}

func (fake *FakePortAllocator) ReleaseAllPortsReturns(result1 error) {
...
func (fake *FakePortAllocator) ReleaseAllPortsReturnsOnCall(i int, result1 error) {
	fake.ReleaseAllPortsStub = nil
...
func (fake *FakePortAllocator) Invocations() map[string][][]interface{} {
...
func (fake *FakePortAllocator) recordInvocation(key string, args []interface{}) {
...
var _ netrules.PortAllocator = new(FakePortAllocator)
