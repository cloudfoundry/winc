...
type NetRuleApplier struct {
	...
	InStub        func(netrules.NetIn, string) (*hns.NatPolicy, *hns.ACLPolicy, error)
	...
	inReturns struct {
		result1 *hns.NatPolicy
		result2 *hns.ACLPolicy
		result3 error
	}
	...
	OutStub        func(netrules.NetOut, string) (*hns.ACLPolicy, error)
...
func (fake *NetRuleApplier) In(arg1 netrules.NetIn, arg2 string) (*hns.NatPolicy, *hns.ACLPolicy, error) {
	fake.inMutex.Lock()
...
func (fake *NetRuleApplier) InCalls(stub func(netrules.NetIn, string) (*hns.NatPolicy, *hns.ACLPolicy, error)) {
	fake.inMutex.Lock()
...
func (fake *NetRuleApplier) InReturns(result1 *hns.NatPolicy, result2 *hns.ACLPolicy, result3 error) {
	fake.inMutex.Lock()
	defer fake.inMutex.Unlock()
	fake.InStub = nil
...
func (fake *NetRuleApplier) InReturnsOnCall(i int, result1 *hns.NatPolicy, result2 *hns.ACLPolicy, result3 error) {
	fake.inMutex.Lock()
	defer fake.inMutex.Unlock()
	fake.InStub = nil
...
func (fake *NetRuleApplier) Out(arg1 netrules.NetOut, arg2 string) (*hns.ACLPolicy, error) {
	fake.outMutex.Lock()
...
func (fake *NetRuleApplier) OutCalls(stub func(netrules.NetOut, string) (*hns.ACLPolicy, error)) {
	fake.outMutex.Lock()
...
func (fake *NetRuleApplier) OutReturns(result1 *hns.ACLPolicy, result2 error) {
	fake.outMutex.Lock()
	defer fake.outMutex.Unlock()
	fake.OutStub = nil
...
func (fake *NetRuleApplier) OutReturnsOnCall(i int, result1 *hns.ACLPolicy, result2 error) {
	fake.outMutex.Lock()
	defer fake.outMutex.Unlock()
	fake.OutStub = nil
